...
def experimentalDesign():
    ...
    S = Strategy.create_strategy('opt_test', 'python3.6 opt_test.py 0.5', '{x} {y}', {"x": 1.0, "y": 1.0})
    ...
    for x,y in itertools.product(*[[0.0, 1.0, 2.0],[0.0, 1.0, 2.0]]):
        ...
        S2 = Strategy.create_strategy('opt_test', 'python3.6 opt_test.py 0.5',  '{x} {y}', params)
